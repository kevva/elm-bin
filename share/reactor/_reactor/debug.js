...
Elm.SideBar.make = function (_elm) {
   ...
   var aggregateUpdates = $Signal.mergeMany(_L.fromArray([A2($Signal.map,
...
Elm.SideBar.Controls.make = function (_elm) {
   ...
   var scrubSlider = F2(function (_v0,
   state) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var sliderLength = _v0._0;
   ...
   {ctor: "_Tuple0"}),
   "restart");
   var textTypefaces = _L.fromArray(["Gotham"
                                    ,"Futura"
                                    ,"Lucida Grande"
                                    ,"sans-serif"]);
   ...
   state) {
      return function () {
         ...
         w,
         textHeight,
         $Graphics$Element.topRight)($Graphics$Element.rightAligned(textStyle($Basics.toString(state.totalEvents))));
         var sliderStartText = A3($Graphics$Element.container,
         w,
         textHeight,
         $Graphics$Element.topLeft)($Graphics$Element.leftAligned(textStyle("0")));
         return A2($Graphics$Element.flow,
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 _v6._0 - 2 * buttonWidth - sideMargin,
                 buttonHeight,
                 ...
                 var midWidth = _v6._0 - sideMargin;
                 ...
                 return A2($Graphics$Element.flow,
                 $Graphics$Element.down,
                 _L.fromArray([controls,bar]));
              }();}
         _U.badCase($moduleName,
         "between lines 208 and 260");
      }();
   });
   _elm.SideBar.Controls.values = {_op: _op
...
Elm.SideBar.Model.make = function (_elm) {
   ...
   if (_elm.SideBar.Model.values)
   return _elm.SideBar.Model.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
      ...
      return function () {
         ...
         {case "Pause":
            return _U.replace([["paused"
                               ,action._0]
                              ,["totalEvents"
                               ,action._0 ? state.totalEvents : state.scrubPosition]],
              state);
            case "Restart":
            ...
            return _U.replace([["totalEvents"
                               ,action._0]
                              ,["scrubPosition",action._0]],
              state);}
         _U.badCase($moduleName,
         "between lines 28 and 52");
      }();
   });
   var startModel = {_: {}
                    ,paused: false
   ...
   _elm.SideBar.Model.values = {_op: _op
                               ,Restart: Restart
                               ,Pause: Pause
...
Elm.SideBar.Watches.make = function (_elm) {
   ...
   var nameAttributes = _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                           ,_0: "margin"
                                                                           ,_1: "20px 0 10px"}
                                                                          ,{ctor: "_Tuple2"
                                                                           ,_0: "font-weight"
   ...
   var watchAttributes = _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                            ,_0: "color"
                                                                            ,_1: "rgb(228, 228, 228)"}]))]);
   var viewWatch = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return A2($Html.div,
              watchAttributes,
              _L.fromArray([viewName(_v0._0)
                           ,viewValue(_v0._1)]));}
         _U.badCase($moduleName,
         "on line 32, column 3 to 55");
      }();
   };
   var viewAttributes = _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                           ,_0: "overflow-y"
                                                                           ,_1: "auto"}
                                                                          ,{ctor: "_Tuple2"
                                                                           ,_0: "overflow-x"
   ...
   var view = function (watches) {
      return $Html.div(viewAttributes)(function () {
         switch (watches.ctor)
         {case "[]":
            return _L.fromArray([noWatches]);}
         return A2($List.map,
         viewWatch,
         watches);
      }());
   };
   _elm.SideBar.Watches.values = {_op: _op
                                 ,view: view
